...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        msg_str = input("Please enter a line of text and press <Enter>: ")
        pub_timestampstring = TimestampString()
        pub_timestampstring.message = msg_str
        pub_timestampstring.timestamp = rospy.get_time()
        
        # Publish our string to the 'chatter_talk' topic
        pub.publish(pub_timestampstring)
